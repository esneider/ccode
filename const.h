...
/**
 * @brief Suffixes or prefixes that modify the type of a constant.
 */
...
/**
 * @brief AST node types for lexer tokens.
 */
enum ast_token {
...
enum ast_external_definition {
    ...
    AST_TRANSLATION_UNIT = 40000, // [AST_EXTERNAL_DECLARATION +]
